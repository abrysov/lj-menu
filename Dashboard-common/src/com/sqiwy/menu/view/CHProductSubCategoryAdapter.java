...
public class CHProductSubCategoryAdapter extends BaseExpandableListAdapter{
	private static final String TAG = "CHProductCategoryAdapter";
	private ArrayList<ProductCategory> mList;
	private Context mContext;
		
	public CHProductSubCategoryAdapter(Context context, ArrayList<ProductCategory> list){
		mContext = context;
