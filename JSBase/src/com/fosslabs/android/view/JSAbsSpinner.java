...
public abstract class JSAbsSpinner extends JSAdapterView<SpinnerAdapter> {
    ...
    public JSAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public JSAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JSAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
    ...
    void recycleAllViews() {
        ...
        final JSAbsSpinner.RecycleBin recycleBin = mRecycler;
