...
public class JSGallery extends JSAbsSpinner implements GestureDetector.OnGestureListener {
    private static final String TAG = "JSGallery";
    ...
    public JSGallery(Context context) {
        this(context, null);
    }

    public JSGallery(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.galleryStyle);
    }

    public JSGallery(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
         ...
         */
        return new JSGallery.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    private void offsetChildrenLeftAndRight(int offset) {
    	JSLog.d(TAG, " offsetChildrenLeftAndRight " + getChildCount());
    ...
    private void setSelectionToCenterChild() {
        JSLog.d(TAG, "setSelectionToCenterChild() ");
    ...
    void layout(int delta, boolean animate) {
        ...
        JSGallery.LayoutParams lp = (JSGallery.LayoutParams) sel.getLayoutParams();
    ...
    private View makeAndAddView(int position, int offset, int x,
        ...
        if (!mDataChanged) {
            ...
            if (child != null) {
                ...
                JSGallery.LayoutParams lp = (JSGallery.LayoutParams) 
    ...
    private void setUpChild(View child, int offset, int x, boolean fromLeft) {
        ...
        JSGallery.LayoutParams lp = (JSGallery.LayoutParams) 
            child.getLayoutParams();
        if (lp == null) {
            lp = (JSGallery.LayoutParams) generateDefaultLayoutParams();
        }
     ...
     */
    private int calculateTop(View child, JSGallery.LayoutParams lp, boolean duringLayout) {
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        JSLog.d(TAG, String.valueOf(e2.getX() - e1.getX()));
    ...
    private void updateSelectedItemMetadata() {
    	JSLog.d(TAG, "updateSelectedItemMetadata() ");
    ...
    int last_center_pos = -1;
    private void animateCenter(){
    	String TAG = "ANIMATE_CENTER";
    	JSLog.d(TAG, " animateCenter() !!!!!!!!! ");
    	int f = getFirstVisiblePosition();
    	int l = getLastVisiblePosition();
    	int galleryCenter = getCenterOfGallery();
    	for(int i = 0; i <= getChildCount(); i++){
    		JSLog.d(TAG, " cur i = " + i + " " + getChildCount());
    		View v = getChildAt(i);
        	if (v == null){
        		JSLog.d(TAG, " v == null ");
        		return;
        	}
        	JSLog.d(TAG, " v != null " + v.getLeft() + " " + galleryCenter + " " + v.getRight());
    		if(v.getLeft() <= galleryCenter && v.getRight() >= galleryCenter) {
    			JSLog.d(TAG, " v -- CENTER!!! " + last_center_pos + " " + i + " " +getChildCount());
    			//v.setAlpha(0.2f);
    			
    			if(last_center_pos != -1){
    				View old = getChildAt(last_center_pos - getFirstVisiblePosition());
    				if(old != null && last_center_pos - getFirstVisiblePosition() != i) old.setAlpha( 1.0f);
    			}
         		last_center_pos = getFirstVisiblePosition() + i;
       		 break;
            }
       	 else{
       		 JSLog.d(TAG, " v != CENTER!!! ");
       		 
       	 }
    	}	
    
    }
    private void anim_item_menu(View v) {
		JSLog.d(TAG, v.getMeasuredWidth() + " " + v.getWidth());
		ObjectAnimator animator = ObjectAnimator
				.ofFloat(v, "rotationX", -90, 0);
		v.setPivotX(v.getMeasuredWidth()/ 2);
		v.setPivotY(0);
		animator.setDuration(1900);
		
		ObjectAnimator animAlpha = ObjectAnimator.ofFloat(v, "alpha", 0, 1);
		animAlpha.setDuration(1900);
